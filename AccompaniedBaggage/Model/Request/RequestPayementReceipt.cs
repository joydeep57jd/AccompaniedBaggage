...
{
    public class RequestPayementReceipt
    {
        ...
        //// Invoice Adjustment Details (cashreceiptinvdtls)
        //public List<CashReceiptInvDtls> InvoiceDetails { get; set; }


        //// Payment Details (cashreceiptdtl)
        //public List<CashReceiptDtl> PaymentDetails { get; set; }
